...
import { APPROVAL_DENIAL_MESSAGE, createApprovalGate } from '../approvals/approval-gate.js';
...
} from '../approvals/fake-approval-hooks.js';
...
import {
  ...
  createFakeMachineProbe,
} from '../machine-load/fake-machine-probe.js';
