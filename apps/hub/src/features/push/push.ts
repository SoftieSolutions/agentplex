...
/**
 * What a subscription is, and what an endpoint may be, are the protocol's --
 * `packages/protocol/src/push.ts`, imported above. They were defined here
 * first and moved the moment a second reader appeared: a client frame carries
 * a subscription, and a rule about what may be stored that disagreed with the
 * rule about what may be sent would be two answers to one question. What is
 * still this file's is everything below -- the table, the key pair, the
 * fan-out.
 */
