...
import { findServer, registerServer, revokeServer } from './server-registrations.js';
import { newServerRegistrationSchema, type LiveServerRegistration } from './pairing.js';
