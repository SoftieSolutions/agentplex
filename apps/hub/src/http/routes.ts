 ...
 *
 * Three routes and a chain, and the order is the only rule in the file that
...
export function createHubRoutes({ clientAuth, web, logger }: HubRouteDependencies): RequestHandler {
