...
#
# `docs/install.md` prints this string and a test holds the two together, so
...
readonly DOCS_URL='https://github.com/SoftieSolutions/agentplex/blob/master/docs/install.md'
